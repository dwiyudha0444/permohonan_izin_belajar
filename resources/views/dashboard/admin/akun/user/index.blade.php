                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Akun User</h6>
                        </div>
                    </div>
                                    ...
                                    @foreach ($user as $usr)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $usr->email }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <a href="{{ route('show_akun_user', ['id' => $usr->id]) }}"
                                                    class="btn btn-primary btn-sm text-xs font-weight-bold me-1"
                                                    data-toggle="tooltip" data-original-title="Show">
                                                    Show
                                                </a>

                                                <form action="{{ route('akun_user_destroy', $usr->id) }}" method="POST"
