    ...
    <div class="col-md-12 mb-lg-0 mb-4">
        <div class="card mt-4">
            ...
            <div class="card-body p-3">
                <div class="table-responsive">
                    <table class="table align-items-center">
                        <tbody>
                            ...
                            <tr>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                    Transkip Nilai Semester 4</th>
                                <td class="text-sm font-weight-normal">
                                    @if (!empty($monitoring->transkip_nilai_4))
                                        <a href="{{ asset('monitoring/assets/transkip_nilai_4/' . $monitoring->transkip_nilai_4) }}"
                                            target="_blank" class="btn btn-info btn-sm">
                                            Lihat Foto
                                        </a>
                                    @else
                ...
                <div class="mt-4">
                    <a href="{{ route('monitoring') }}" class="btn bg-gradient-primary">Kembali</a>
                </div>
            </div>
        </div>
    </div>
